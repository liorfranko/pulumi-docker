...
export declare let assumeRole: outputs.config.AssumeRole | undefined;
export declare let endpoints: outputs.config.Endpoints[] | undefined;
export declare let forbiddenAccountIds: string[] | undefined;
/**
 * Configuration block with settings to ignore resource tags across all resources.
 */
export declare let ignoreTags: outputs.config.IgnoreTags | undefined;
/**
